...
const calendarStyles = (
  <GlobalStyles
    styles={{
      ...
      ".rbc-toolbar button:hover": { background: alpha("#2563eb", 0.08), borderColor: "#2563eb", color: "#1e40af" },
      ...
      ".rbc-today .rbc-header": { color: "#1d4ed8" },
      ".rbc-today": { background: alpha("#2563eb", 0.04) },
      ...
      ".rbc-event:hover": { background: alpha("#2563eb", 0.25), boxShadow: `0 2px 8px ${alpha("#2563eb", 0.25)}` },
      ".rbc-event.rbc-selected": { background: alpha("#2563eb", 0.3), outline: `2px solid #2563eb` },
      ".rbc-event-label": { fontSize: 10, opacity: 0.85, fontWeight: 400 },
      ".rbc-event-content": { lineHeight: 1.3 },
      ".rbc-show-more": { color: "#2563eb", fontWeight: 600, fontSize: 11 },
